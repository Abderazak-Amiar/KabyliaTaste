...
namespace KabyliaTaste.Services
{
    public static class AppLocalization
    {
        private static readonly Dictionary<string, string> French = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Save Database Backup"] = "Enregistrer la sauvegarde de la base de données",
            ["Select Database Backup"] = "Sélectionner une sauvegarde de base de données",
            ["Preparing database backup..."] = "Préparation de la sauvegarde de la base de données...",
            ["Uploading database backup..."] = "Téléversement de la sauvegarde de la base de données...",
            ["Upload complete."] = "Téléversement terminé.",
            ["The database file was not found."] = "Le fichier de base de données est introuvable.",
            ["Database backup created successfully."] = "Sauvegarde de la base de données créée avec succès.",
            ["Failed to create backup:"] = "Échec de création de la sauvegarde :",
            ["Restore Backup"] = "Restaurer la sauvegarde",
            ["This will replace the current local database file. Continue?"] = "Cela remplacera le fichier local de base de données actuel. Continuer ?",
            ["Failed to restore backup:"] = "Échec de restauration de la sauvegarde :",
            ["Database restored. The application will restart."] = "Base de données restaurée. L'application va redémarrer.",
            ["Failed to upload database to Google Drive before closing:"] = "Échec du téléversement de la base de données vers Google Drive avant la fermeture :",
            ["Failed to upload database to Google Drive:"] = "Échec du téléversement de la base de données vers Google Drive :",
            ["Downloading database backup from Google Drive..."] = "Téléchargement de la sauvegarde de la base de données depuis Google Drive...",
            ["Download complete."] = "Téléchargement terminé.",
            ["Database uploaded to Google Drive successfully."] = "Base de données téléversée sur Google Drive avec succès.",
            ["Database downloaded from Google Drive successfully. The application will restart."] = "Base de données téléchargée depuis Google Drive avec succès. L'application va redémarrer.",
            ["Failed to download database from Google Drive:"] = "Échec du téléchargement de la base de données depuis Google Drive :",
            ...
            ["Delete this sale? The stock will be restored."] = "Supprimer cette vente ? Le stock sera rétabli.",
            ["Sale updated successfully."] = "Vente mise à jour avec succès.",
            ["Select a sale to delete."] = "Sélectionnez une vente à supprimer.",
            ...
            ["Select an expense to update."] = "Sélectionnez une dépense à mettre à jour.",
            ...
            ["No sales were found for the selected invoice."] = "Aucune vente n'a été trouvée pour la facture sélectionnée.",
            ["Select an invoice to delete."] = "Sélectionnez une facture à supprimer.",
            ["Select a valid invoice to delete."] = "Sélectionnez une facture valide à supprimer.",
            ["Are you sure you want to delete the selected invoice?"] = "Voulez-vous vraiment supprimer la facture sélectionnée ?",
            ["Amount paid must be a valid number."] = "Le montant payé doit être un nombre valide.",
            ["Amount paid must not exceed the invoice total."] = "Le montant payé ne doit pas dépasser le total de la facture.",
            ["Database backup created successfully."] = "Sauvegarde de la base de données créée avec succès.",
            ["Status"] = "Statut",
            ["No"] = "Non",
            ["Yes"] = "Oui",
